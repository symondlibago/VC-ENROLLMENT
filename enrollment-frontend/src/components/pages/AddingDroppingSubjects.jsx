                        ...
                        <div className="p-6 space-y-6 overflow-y-auto">
                            <div className="border rounded-lg p-4 bg-gray-50/50">
                                ...
                                <div className="grid grid-cols-2 gap-x-4 gap-y-2 text-sm">
                                    ...
                                    <p className="flex items-center col-span-2"><Book size={14} className="mr-2 text-gray-500" /> <b>Course:</b> &nbsp;{student.course?.course_name || 'Not available'}</p>
                                </div>
                            </div>
    ...
    return (
        <>
                        ...
                        <Table>
                            ...
                            <TableBody>
                                {changeRequests.map(req => {
                                    const studentName = `${req.student?.last_name}, ${req.student?.first_name}, ${req.student?.middle_name ? req.student.middle_name.charAt(0) + '.' : ''}`;
            ...
            <SubjectChangeDetailsModal
                ...
                onStatusChange={fetchChangeRequests}
            />
        </>
    );
};
